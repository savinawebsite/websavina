<%@ Page Title="" Language="C#" MasterPageFile="~/backend/adTemplate.master" AutoEventWireup="true" CodeFile="order_process.aspx.cs" Inherits="backend_order_process" %>
            ...
            <div class="">
              <div class="page-title">
                <div class="title_left">
                  <h3>XỬ LÝ ĐƠN HÀNG SỐ :  <STRONG>#2018001</STRONG></h3>
                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control">
                                        <option>Tự lắp đặt</option>
                                        <option>Thợ đến lắp</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control">
                                        ...
                                        <option>Giao/nhận tận nhà</option>
                                      </select>
                                </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <table class="table table-striped table-bordered">
                                  ...
                                  <tr>
                                      ...
                                      <td><input type="number" value="1" class="input" style="width:40px">
                                  ...
                                  <tr>
                                      ...
                                      <td><input type="number" value="2" class="input" style="width:40px">
                                        <span><a href="#" class="btn btn-danger btn-xs" style="margin-bottom:1px; margin-left: 3px;"><i class="fa fa-remove"></i></a></span>
                                      </td>
                                  </tr>
                                </table> 
                        ...
                        <div class="ln_solid"></div>
                          <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                              ...
                              <button type="orderRented" class="btn btn-primary" type="reset">Tiến hành cho thuê đơn hàng</button>
                              <button type="orderFinish" class="btn btn-success">Đã nhận lại đơn hàng</button>
                            </div>
                          </div>
                      </div>
                  </div>
